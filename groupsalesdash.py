...
if data is None:
    ...
    if page == 'Sales by Game':
        ...
        if filtered_rep_data.empty:
            ...
            if game_cumulative_option == 'Cumulative Group Sales ($) for Each Game':
                ...
                cumulative_orders_by_game = data.groupby(['event_name_display', 'acct_id']).size().groupby('event_name_display').count().reset_index(name='total_orders')
    ...
    st.title("Cumulative Statistics for Sales Representatives")
